...
public class ImageMarkLogoByIcon {
    ...
    public static void main(String[] args) {
        String srcImgPath = "G:\\images/car.jpg";
        String iconPath = "G:\\images/deal.jpg";
        String targerPath = "G:\\images/img_mark_icon.jpg";
        String targerPath2 = "G:\\images/img_mark_icon_rotate.jpg";
        // 给图片添加水印
